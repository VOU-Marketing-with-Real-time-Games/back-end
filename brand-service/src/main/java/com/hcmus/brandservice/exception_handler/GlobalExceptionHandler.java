package com.hcmus.brandservice.exception_handler;

import com.hcmus.brandservice.exception.BranchExistedException;
...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler({ BranchExistedException.class, BrandExistedException.class })
     ...
     * @return an ErrorDTO containing error details
     */
    @ExceptionHandler({ BranchNotFoundException.class, BrandNotFoundException.class})
